                        ...
                        <article class="card border-0 shadow-sm dashboard-panel">
                            ...
                            @else
                                @foreach ($templates as $template)
                                    <form class="card border-0 shadow-sm" method="POST" action="{{ route('agreements.templates.update', $template) }}" style="margin-bottom: 1rem;">
                                        @csrf
                                        @method('PUT')
